...
commands = [
    ...
    [sys.executable, "-m", "Edge_cosine_general_reference_network.run_network", "--condition", "healthy"],
    [sys.executable, "-m", "Edge_cosine_general_reference_network.run_network", "--condition", "obese"],
]
