# =============================================================================
#  EDGE COSINE GENERAL REFERENCE NETWORK  (HEALTHY CONDITION)
#  Configuration file
#
...
#      uv run -m Edge_cosine_general_reference_network.run_network --condition healthy --viz-only
#
#  To wipe cache and restart from scratch:
#      uv run -m Edge_cosine_general_reference_network.run_network --condition healthy --reset
# =============================================================================
...
VIZ_TITLE_OVERVIEW = "Healthy Cosine General Network — Bootstrap Strength Overview"
VIZ_TITLE_ROBUST   = "Healthy Cosine General Network — Robust Connections"
