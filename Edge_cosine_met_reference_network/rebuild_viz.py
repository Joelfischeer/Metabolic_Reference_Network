...
commands = [
    ...
    [sys.executable, "-m", "Edge_cosine_met_reference_network.run_network", "--condition", "healthy", "--viz-only"],
    [sys.executable, "-m", "Edge_cosine_met_reference_network.run_network", "--condition", "obese",   "--viz-only"],
]
