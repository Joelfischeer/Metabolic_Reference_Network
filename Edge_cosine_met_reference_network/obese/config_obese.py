# =============================================================================
#  EDGE COSINE METABOLISM REFERENCE NETWORK  (OBESE / HIGH-BMI CONDITION)
#  Configuration file
#
...
#      uv run -m Edge_cosine_met_reference_network.run_network --condition obese --viz-only
#
#  To wipe cache and restart from scratch:
#      uv run -m Edge_cosine_met_reference_network.run_network --condition obese --reset
# =============================================================================
...
VIZ_TITLE_OVERVIEW = "Obese / High-BMI Cosine Metabolic Network — Bootstrap Strength Overview"
VIZ_TITLE_ROBUST   = "Obese / High-BMI Cosine Metabolic Network — Robust Connections"
