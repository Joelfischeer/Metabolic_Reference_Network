...
Run from the Metabolic_Reference_Network/ directory:
    uv run -m Edge_cosine_met_reference_network.run_llm_descriptions --condition healthy
    uv run -m Edge_cosine_met_reference_network.run_llm_descriptions --condition obese
